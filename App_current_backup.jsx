        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="text-center mb-12 pt-8">
            <div className="inline-flex items-center gap-3 bg-white bg-opacity-10 backdrop-blur-lg px-6 py-3 rounded-full border border-white border-opacity-20 mb-6">
              ...
              <span className="text-white font-semibold">Powered by Solana + Helius RPC</span>
            </div>
            ...
            <p className="text-xl text-white text-opacity-70 max-w-2xl mx-auto mb-8">
              Revolutionary blockchain platform ensuring transparent, verifiable, and fraud-resistant humanitarian aid distribution powered by Solana and Helius RPC
            </p>
            
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <div className="bg-white bg-opacity-10 backdrop-blur-lg px-4 py-2 rounded-full border border-white border-opacity-20">
                <span className="text-white text-sm font-medium">🌍 Global Humanitarian Aid</span>
              </div>
              <div className="bg-white bg-opacity-10 backdrop-blur-lg px-4 py-2 rounded-full border border-white border-opacity-20">
                <span className="text-white text-sm font-medium">🔒 Privacy-First Design</span>
              </div>
              <div className="bg-white bg-opacity-10 backdrop-blur-lg px-4 py-2 rounded-full border border-white border-opacity-20">
                <span className="text-white text-sm font-medium">⚡ Real-Time Blockchain</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-lg p-6 rounded-2xl border border-white border-opacity-20 hover:bg-opacity-20 transition-all">
              ...
              <p className="text-white text-opacity-60 text-sm">All transactions recorded permanently on Solana blockchain via Helius RPC</p>
            </div>
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-white mb-4">Why Choose AidLedger?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-white text-opacity-60 text-sm">Blockchain-backed security</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-white text-opacity-60 text-sm">2-3 second confirmations</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-white text-opacity-60 text-sm">Worldwide humanitarian aid</p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-white font-semibold mb-2">Humanitarian</h3>
                <p className="text-white text-opacity-60 text-sm">Built for aid organizations</p>
              </div>
            </div>
          </div>
